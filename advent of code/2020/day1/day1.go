        ...
        for j := 0; j < 199; j++ {
            for k := 0; k < 199; k++ {
                if (input[j] + input[i] + input[k] == 2020) {
                    fmt.Println("FOUND IT", input[j], "+", input[i], "+", input[k], "=", input[j] + input[i] + input[k])
                    fmt.Println(input[j] * input[i] * input[k])
                    i = 199
                }
            }
        }
